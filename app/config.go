...
type config struct {
	...
	RedisGameServerSessionLocalConn      string        `mapstructure:"REDIS_GAME_SERVER_SESSION_LOCAL_CONN"`
	RedisGameServerSessionTestConn       string        `mapstructure:"REDIS_GAME_SERVER_SESSION_TEST_CONN"`
	RedisGameServerSessionDevConn        string        `mapstructure:"REDIS_GAME_SERVER_SESSION_DEV_CONN"`
	RedisGameServerSessionStagingConn    string        `mapstructure:"REDIS_GAME_SERVER_SESSION_STAGING_CONN"`
	RedisGameServerSessionProductionConn string        `mapstructure:"REDIS_GAME_SERVER_SESSION_PRODUCTION_CONN"`
